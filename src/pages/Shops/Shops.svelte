<script lang="typescript">
    ...
    import CommonMap from '../../common/components/Map/CommonMap/CommonMap.svelte'
    import { CommonTable as CommonTableInterface } from '../../common/components/Tables/CommonTable/utils'
    import SimpleTextElement from '../../common/components/ElementsAndBlocks/SimpleTextElement/SimpleTextElement.svelte'
    import MapActionElement from '../../common/components/ActionElements/MapActionElement/MapActionElement.svelte'
    import ShopActionsElement from './ShopActionsElement/ShopActionsElement.svelte'
    ...
    import MapContainer from '../../common/components/Map/MapContainer/MapContainer.svelte'
    import UrlElement from '../../common/components/ElementsAndBlocks/UrlElement/UrlElement.svelte'
