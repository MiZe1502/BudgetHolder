...
<ButtonIcon disabled={disabled} className="{Button} {className}"
    ...
    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
         ...
         xml:space="preserve">
        <path d="M48.032,1.443c-5.095-2.957-11.623-1.224-14.58,3.871c-0.946,1.63-1.444,3.482-1.441,5.367v469.333
