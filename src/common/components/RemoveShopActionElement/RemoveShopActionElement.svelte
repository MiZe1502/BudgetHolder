...
<div>
    ...
    {#if isPopupOpened}
        <PopupContainer onAcceptHandler={onAcceptHandler} onCancelHandler={onCloseHandler} withAcceptButton={true} withCancelButton={true} title={`Remove ${data.name}` || "Remove"} isPopupOpened={isPopupOpened} onCloseHandler={onCloseHandler} popupClass={Popup}>
